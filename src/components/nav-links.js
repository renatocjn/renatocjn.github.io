...
export default () => {
  ...
  const getOnclickScroller = (targetId) => (
    (e) => {
  ...
  return (
    <>
      <ListItem
        button
        onClick={getOnclickScroller('bio')}
        component="a"
      ...
      <ListItem
        button
        onClick={getOnclickScroller('timeline')}
        component="a"
        className={classes.navItems}
      >
        <ListItemIcon>
      ...
      <ListItem
        button
        onClick={getOnclickScroller('skills')}
        component="a"
        className={classes.navItems}
      >
        <ListItemIcon>
      ...
      <ListItem
        button
        onClick={getOnclickScroller('published_work')}
        component="a"
        className={classes.navItems}
      >
        <ListItemIcon>
