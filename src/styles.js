...
const styles = makeStyles((thm) => ({
  ...
  navItems: {
    padding: thm.spacing(0, 5),
  },
  navItemNested: {
    paddingLeft: thm.spacing(9),
  },
  dividerWithPadding: {
  ...
  section: {
    padding: thm.spacing(1),
    marginBottom: thm.spacing(1),
    '&:last-child ': {
      marginBottom: thm.spacing(0),
    },
  },
  sectionContent: {
    marginTop: thm.spacing(3),
    padding: '0 !important',
  },
  sectionAvatar: {},
  sectionTitle: {
    fontSize: '1.75rem',
    fontWeight: 450,
    marginLeft: thm.spacing(1),
  },
  sectionSubheader: {
    fontSize: '1.15rem',
    fontWeight: 300,
    marginLeft: thm.spacing(2.5),
  },
  bioText: {
    fontSize: '1.2em',
    lineHeight: 1.75,
    fontWeight: 375,
    padding: thm.spacing(0, 2),
    whiteSpace: 'pre-line',
    wordSpace: '1.25em',
  },
  educationEntry: {},
  ...
  skillModal: {
    ...
    boxShadow: thm.shadows[5],
    padding: thm.spacing(4, 8, 6),
